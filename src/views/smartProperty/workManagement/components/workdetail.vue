  ...
  <div style="height: 100%">
    <div class="bottom">
      ...
      <div class="">
              ...
              <div class="flexboxs">
                <div class="video-web-content-title" style="font-size:16px;">{{parentData.code}}</div>
                <div class="video-web-content-title flexbox margin-left-25">
                 <template>
                   ...
                   <div v-else-if="parentData.status =='hang'">
                      <div class="status success1">
                       <div>已挂起</div>
                     </div>
                   </div>
                 </template>
            ...
            <div class="s_l">
              <div class="info_item">
                <div class="titleStatus">
                  ...
                  <div v-if="i.workOrderStatus=='挂起'" class="title hangStatus">{{i.workOrderStatus}}</div>
    ...
    <div class="images">
      ...
      >
        <div style="text-align:center;">
          <img :src="bigSrc" alt="" class="imgs" v-if="bigSrc.indexOf('data:video/mp4') == -1">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getWorkOrderById() {
        // let obj = getObjByKey(this.permission.getWorkOrderById);
        let url = '/pm/repair/order/query/'
        let method = 'GET'
        let id = this.parentData.id;
        searchWorkorderById(url, method, id).then(res => {
      ...
      onfeedback() {
        this.$refs.form.validate((valid) => {
          if (valid) {
            ...
            let url = '/pm/repair/order/feedback/process'
            let method = 'POST'
            let data = this.feedbackForm;
            feedback(url, method, data).then(res => {
