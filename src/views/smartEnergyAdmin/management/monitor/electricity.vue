<template>
  <div class="app-container electrBox" style="">
    <div style="display: flex">
      ...
      <div class="electrBox" style="width: 100%">
        <div>
          <el-form
            ref="formSearch"
            inline
            ...
            v-if="showSearch"
          >
            <el-form-item prop="code" label="电表号">
              <el-input
                placeholder="请输入电表号"
                clearable
                v-model="monitorSite.deviceCode"
              ></el-input>
            </el-form-item>
            <el-form-item prop="name" label="用户名">
              <el-input
                placeholder="请输入用户名"
                clearable
                v-model="monitorSite.deviceName"
              ></el-input>
            </el-form-item>
        ...
        <div>
          ...
          >
            ...
            <!-- <el-table-column prop="area" label="用户区域" show-overflow-tooltip></el-table-column> -->
            <!-- <el-table-column prop="name" label="用电类型" show-overflow-tooltip></el-table-column> -->
            <el-table-column
              prop="deviceCode"
              label="电表号"
            ...
            <el-table-column
              ...
              show-overflow-tooltip
            ></el-table-column>
            <!-- <el-table-column prop="code" label="电费" show-overflow-tooltip></el-table-column> -->
            <el-table-column
              prop="collectTime"
              label="数据更新时间"
            ></el-table-column>
            <el-table-column label="操作" show-overflow-tooltip width="300">
              <template slot-scope="scope">
                <el-button @click="manualAlarm(scope.row)" type="text"
                  >手动告警</el-button
                >
                <!-- <el-button @click="onLook(scope.row)" type="text">实时数据</el-button>
        ...
        >
          <el-row>
            <div class="data_dv" style="">
              ...
              <el-button plain type="primary" @click="manualAlarm()"
                >手动告警</el-button
              >
            </div>
            <el-form
            ...
            >
              ...
              <el-col :span="12">
                <el-form-item prop="hydropowerDeviceTypeStr" label="设备分类">
                  <el-input
                    v-model="addForm.hydropowerDeviceTypeStr"
                    placeholder="请输入设备分类"
                    disabled
                  ></el-input>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item prop="deviceTypeStr" label="电表分类">
                  <el-input
                    v-model="addForm.deviceTypeStr"
                    placeholder="请输入电表分类"
                    disabled
                  ></el-input>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item prop="value" label="累计用电量">
                  <el-input
              ...
              <el-col :span="12">
                <el-form-item prop="au" label="A相电压">
                  <el-input
                    v-model="addForm.au"
                    placeholder="请输入A相电压"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="ai" label="A相电流">
                  <el-input
                    v-model="addForm.ai"
                    placeholder="请输入A相电流"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="ap" label="A相有功功率">
                  <el-input
                    v-model="addForm.ap"
                    placeholder="请输入A相有功功率"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="bu" label="B相电压">
                  <el-input
                    v-model="addForm.bu"
                    placeholder="请输入B相电压"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="bi" label="B相电流">
                  <el-input
                    v-model="addForm.bi"
                    placeholder="请输入B相电流"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="bp" label="B相有功功率">
                  <el-input
                    v-model="addForm.bp"
                    placeholder="请输入B相有功功率"
                  ></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item prop="cu" label="C相电压">
                  <el-input
                    v-model="addForm.cu"
                    placeholder="请输入C相电压"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="ci" label="C相电流">
                  <el-input
                    v-model="addForm.ci"
                    placeholder="请输入C相电流"
                  ></el-input>
              ...
              <el-col :span="12">
                <el-form-item prop="cp" label="C相有功功率">
                  <el-input
                    v-model="addForm.cp"
                    placeholder="请输入C相有功功率"
                  ></el-input>
                </el-form-item>
              </el-col>
            </el-form>
        ...
        <el-dialog
          :close-on-click-modal="false"
          title="手动告警"
          :visible.sync="manualAlarmShow"
          :before-close="carDialogClose1"
          width="42%"
        >
          <el-row>
            <el-form
            ...
            >
              ...
              <el-col :span="12">
                <el-form-item prop="deviceCode" label="设备编码">
                  <el-input
                    v-model.trim="reportAlarm.deviceCode"
                    disabled
                    placeholder="请输入设备编码"
                  ></el-input>
                </el-form-item>
              ...
              <el-col :span="12">
                <el-form-item label="告警类型" prop="eventCode">
                  <el-select
                    style="width: 100%"
                    v-model="reportAlarm.eventCode"
                    placeholder="请选择告警类型"
          ...
          <div slot="footer" style="text-align: center">
            <el-button
              ...
              >确定</el-button
            >
            <el-button @click="cancel1()" class="video-web-plain-btn"
              >取消</el-button
            >
          </div>
        </el-dialog>
        ...
        <el-dialog
          :close-on-click-modal="false"
          title="历史数据"
          :visible.sync="historydataShow"
          :before-close="carDialogClose2"
          width="62%"
        >
          <div>
            <div class="data_dv" style="">
              ...
              <div style="display: flex">
                ...
                <el-button
                  ...
                  icon="el-icon-search"
                  type="primary"
                  @click="historyonSearch()"
                  >搜索</el-button
                >
                <el-button icon="el-icon-refresh-left" @click="historyonReset()"
                  >重置</el-button
                >
              </div>
            </div>
            ...
            >
              ...
              <el-table-column prop="value" label="累计用电量 (kw/h)">
              </el-table-column>
              ...
              <el-table-column label="功率" align="center">
                <el-table-column prop="ap" label="A相有功功率">
                </el-table-column>
                <el-table-column prop="bp" label="B相有功功率">
                </el-table-column>
                <el-table-column prop="cp" label="C相有功功率">
                </el-table-column>
              </el-table-column>
            </el-table>
            <!-- 分页 -->
            <pagination
              v-show="historytableData && historytableData.length > 0"
              @pagination="historyhandleCurrentChange"
              :page.sync="historymonitorSite.pageNum"
              :pageSizes="[10, 20, 30, 40]"
              :limit.sync="historymonitorSite.pageSize"
              :total="historypagination"
            />
          </div>
          <div slot="footer" style="text-align: center">
            <!-- <el-button @click="onSubmit()" type="primary" class="video-web-main-btn">确定</el-button> -->
            <el-button @click="cancel2()" class="video-web-plain-btn"
              >关闭</el-button
            >
          </div>
        </el-dialog>
        ...
        >
          ...
          <div slot="footer" style="text-align: center">
            <el-button
              ...
              >确定</el-button
            >
            <el-button @click="cancel3()" class="video-web-plain-btn"
              >取消</el-button
            >
          </div>
        </el-dialog>
...
export default {
  ...
  methods: {
    ...
    init() {
      // this.getVisitorData();
      this.deviceInfo();
      this.monitorSite.endDate = Moment().format('YYYY-MM-DD')//默认今天
      this.monitorSite.startDate = Moment().subtract(1, "day").format("YYYY-MM-DD"); //默认昨天
    },
    // 获取设备信息
    deviceInfo() {
      let obj = {
    ...
    gethistoryVisitorData(subType, code) {
      ...
      $environMonitor
        .history(subType, code, this.historymonitorSite)
        .then((res) => {
    ...
    getVisitorData() {
        if (this.time.length) {
        this.monitorSite.startDate = this.time[0];
        this.monitorSite.endDate = this.time[1];
      }
      $environMonitor
        .getRealtimeAmmeter(this.monitorSite)
        .then((res) => {
          this.tableData = res.data.data;
          res.data.data.forEach((item) => {
            item.collectTime = item.collectTime.slice(0, 10);
          });
    ...
    manualAlarm(rows) {
      this.reportAlarm.deviceCode = rows.deviceCode;
    ...
    // 重置
    onReset() {
      this.monitorSite.deviceCode = "";
      this.monitorSite.deviceName = "";
      this.monitorSite.startDate = "";
      this.monitorSite.endDate = "";
      this.time = "";
    ...
    onLook(rows) {
      ...
      this.reportAlarm.deviceCode = rows.code;
    ...
    onSubmit() {
      this.$refs.addForm1.validate((valid) => {
        if (valid) {
          $environMonitor.reportAlarm(this.reportAlarm).then((res) => {
