<template>
    <div class="app-container" style="display: flex;">
        <regiontree @nodeclick="nodeclick" :type="'1'" :nodeType = " 'waterMeter' "></regiontree>
        <div style="height: 100%;width: 100%;">
            <div>
                <el-form ref="formSearch" inline :model="monitorSite" v-if="showSearch">
                    ...
                    <el-form-item prop="subType" label="水表分类">
                        <el-select v-model="monitorSite.subType" clearable>
                            <el-option v-for="item in waterMeter" :key="item.name" :label="item.name" :value="item.value">
                            </el-option>
                        </el-select>
                    </el-form-item>
            ...
            <!-- 表格数据 -->
            <div>
                <el-table ref="multipleTable" :data="tableData" style="width: 100%" height="630">
                    ...
                    <el-table-column prop="belongSubsystem" label="设备分类"></el-table-column>
                    <el-table-column prop="subTypeStr" label="水表分类"></el-table-column>
            ...
            <el-dialog :close-on-click-modal="false" :title="siteTitle" :visible.sync="addSortDialogShow"
                ...
                <el-row>
                    ...
                    <el-form ref="addForm" :model="addForm" class="demo-form-inline" labelWidth="100px" :disabled="isLook"
                        ...
                        <el-col :span="12">
                            <el-form-item prop="deviceTypeStr" label="水表分类">
                                <el-input v-model="addForm.deviceTypeStr" placeholder="请输入水表分类"
                                    disabled></el-input>
                            </el-form-item>
                        </el-col>
                        <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item prop="value" label="累计流量">
            ...
            <el-dialog :close-on-click-modal="false" title="手动告警" :visible.sync="manualAlarmShow"
                ...
                <el-row>
                    <el-form ref="addForm1" :model="reportAlarm" class="demo-form-inline" labelWidth="100px"
                        ...
                        <el-col :span="12">
                            <el-form-item prop="deviceCode" label="设备编码">
                                <el-input v-model.trim="reportAlarm.deviceCode" disabled placeholder="请输入设备编码"></el-input>
                            </el-form-item>
                        </el-col>
                        <!-- <el-col :span="12">
                        ...
                        <el-col :span="12">
                            <el-form-item label="告警类型" prop="eventCode">
                                <el-select style="width: 100%;" v-model="reportAlarm.eventCode" placeholder="请选择告警类型"
                                    :popper-append-to-body="false">
                                    <el-option v-for="(item, index) in alarmTypes" :label="item.name" :value="item.value"
                                        :key="index"></el-option>
                                </el-select>
                            </el-form-item>
                        </el-col>
            ...
            <el-dialog :close-on-click-modal="false" title="历史数据" :visible.sync="historydataShow"
                ...
                <div>
                    ...
                    <el-table :data="historytableData" style="width: 100%" ref="multipleTable">
                        ...
                        <el-table-column prop="collectTime" label="获取数据时间" show-overflow-tooltip></el-table-column>
                ...
                <div slot="footer" style="text-align:center;">
                    <!-- <el-button @click="onSubmit()" type="primary" class="video-web-main-btn">确定</el-button> -->
                    <el-button @click="cancel2()" class="video-web-plain-btn">关闭</el-button>
                </div>
            </el-dialog>
            <!-- 监测频率 -->
...
export default {
    ...
    data() {
        return {
            ...
            reportAlarmRules: {
                eventCode: [
                    { required: true, message: '请选择告警类型', trigger: ['blur', 'change'] }
                ],
            },
            deviceInfoArr: [],
            alarmTypes: [
