...
<template>
  <div class="app-container-bow">
    ...
    <div class="video-web-right-box-bottom">
      ...
      <div class="heights">
    <el-dialog title="通行记录" :visible.sync="dialogVisible" width="60%">
      <el-table
        ref="multipleTable"
        :data="DoorTableData"
        tooltip-effect="dark"
      ...
      spanList: [
        {
          ...
          num: 0,
          name: "门禁总数",
          path: require(`@/assets/images/smartBuild/m1.png`)
        },
        {
          type: "off-line",
          num: 0,
          name: "门禁开启",
          path: require(`@/assets/images/smartBuild/m2.png`)
        },
        {
          type: "off-line",
          num: 0,
          name: "门禁关闭",
          path: require(`@/assets/images/smartBuild/m3.png`)
        },
        {
          type: "off-line",
          num: 0,
          name: "门禁报警",
          path: require(`@/assets/images/smartBuild/m4.png`)
        },
        {
          type: "off-line",
          num: 0,
          name: "门禁离线",
          path: require(`@/assets/images/smartBuild/m5.png`),
        }
      ]
    };
  },
