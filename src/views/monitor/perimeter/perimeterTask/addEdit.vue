  ...
  <div class="app-container-gis">
    <div id="cesiumContainer">
      ...
      <div class="rightBox" v-if="addFormShow">
        <div class="addTitle">{{ addOrEditTitle }}周界任务</div>
        ...
        <div style="margin-top: 15px">
          ...
          >
            ...
            <el-form-item label="创建时间" v-if="addOredit">
              <el-input
            ...
            <!-- <el-form-item label="布控时间" prop="creatTime">
              <el-date-picker
                :disabled="addOredit"
...
import { addTask, editTask, detailTask } from "@/api/monitor/perimeterTask";
...
export default {
    ...
    return {
      ...
      addRules: {
        ...
        taskName: [
          ...
          { max: 30, message: '最多输入30个字', trigger: ['blur', 'change'] }
        ],
        creatTime: [
          {
            required: true,
  ...
  methods: {
    ...
    getDetail(id) {
      detailTask(id).then((res) => {
        ...
        this.addForm.creatTime = [
          res.data.monitorStartDate,
          res.data.monitorEndDate,
        ];
    ...
    // 取消创建
    goBack() {
      this.$router.push({ name: "PerimeterTask" });
    },
    // 删除摄像机
