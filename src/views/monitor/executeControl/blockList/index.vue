      ...
      <el-col :span="4" :xs="24">
        <div class="highlight-height-main padding-20">
          <div class="addGroupBtn">
            <span>人员黑名单组</span>
            <el-button type="text" @click="groupCreate">创建</el-button>
          </div>
          <div
            class="btnList"
          ...
          >
            <el-input
              ...
              placeholder="请输入人员黑名单组名称"
              style="width: 75%"
              clearable
              @clear="groupSearch"
            ></el-input>
            <el-button type="primary" style="width: 20%" @click="groupSearch"
              >搜索</el-button
            >
          </div>
          <div class="btnList">
            <div class="tabList" v-if="tabLists.length">
              ...
              >
                <div
                  :class="activeIndex != index ? 'defStyle' : 'actives'"
                  @click="tabClick(item, index)"
                >
                  {{ item.name }}
                </div>
                <div class="btnRight">
                  <el-button type="text" @click="groupDel(item)"
                    >删除</el-button
                  >
                  <el-button type="text" @click="groupEdit(item)"
                    >修改</el-button
                  >
                </div>
              </div>
        ...
        <div class="video-web-right-box-bottom">
          ...
          >
            ...
            <el-form-item>
              ...
              <el-button icon="el-icon-refresh-left" @click="personReset()"
                >重置
              </el-button>
            </el-form-item>
            <el-form-item style="float: right; margin-right: 0px">
              <el-button @click="personAdd" type="primary">添加人员 </el-button>
            </el-form-item>
          </el-form>
          ...
          <el-row :gutter="10">
            <el-col :span="4" v-for="(item, index) in contentList" :key="index">
              <el-card shadow="hover" class="cardMBottom">
                ...
                />
                <div>
                  <div class="perName">姓名：{{ item.name }}</div>
                  <div>性别：{{ item.genderStr }}</div>
                  <div>更新时间：{{ item.createTime }}</div>
                </div>
                <el-button type="text" @click="personDel(item)">移除</el-button>
                <el-button type="text" @click="personEdit(item)"
                  >修改</el-button
                >
                <el-button type="text" @click="personTrack(item)"
                  >轨迹</el-button
                >
              </el-card>
            </el-col>
