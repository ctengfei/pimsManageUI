    ...
    <div class="app-container">
      ...
      >
        <el-row>
          ...
          >
            <el-col>
              <el-form-item prop="groupId" label="车辆白名单组"
                :rules="[
                  { required: true, message: '请选择车辆白名单组', trigger: ['blur','change'] }
                ]">
                <el-select
                  v-model="addForm.groupId"
                  style="width:100%"
                  placeholder="请选择车辆白名单组"
                >
                  <el-option
      ...
      >
        <el-row>
          ...
          >
            <el-col>
              <el-form-item prop="name" label="车辆白名单组"
                :rules="[
                  { required: true, message: '请输入车辆白名单组名称', trigger: ['blur','change'] }
                ]">
                <el-input
  ...
  export default {
    ...
    methods: {
      ...
      groupCreate(){
        ...
        this.groupTitle = "创建车辆白名单组"
      },
      // 修改黑名单组
      groupEdit(item){
        this.groupType = 'edit'
        this.addGroupShow = true
        this.groupTitle = "修改车辆白名单组"
        this.$nextTick(() => {
            // 注意看这里
