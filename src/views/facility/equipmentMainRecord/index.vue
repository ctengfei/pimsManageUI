<template>
  <div class="app-container">
    <el-row :gutter="20" style="overflow-y:hidden;height:100%">
      <el-col>
          ...
          <right-toolbar :showSearch.sync="showSearch" @queryTable="getTableData"></right-toolbar>
           ...
           <div>
              <el-table :data="tableData" style="width: 100%">
                ...
                />
                <el-table-column
                  prop="maintenanceContacterPhone"
                  label="手机号"
                  showOverflowTooltip
                />
                <el-table-column
...
export default {
  ...
  data() {
    return {
      // permission: {
      //   search: "facility::protectionRecord::search",
      //   download: "facility::protectionRecord::download",
  ...
  methods: {
    ...
    getType() {
      //let obj = getObjByKey(this.permission.sysChild);
      let parmas = {
        nodeType: "DIR"
      };
    ...
    getTableData() {
      ...
      // console.log(obj);/pm/device/maintenance
      initTabData('/maintenance/record/page', 'get', this.formSearch).then(res => {
        if (res.code === 200) {
    ...
    btnExport() {
      ...
      downloadworkOrder('/maintenance/record/page/export', 'get', data)
        .then(res => {
