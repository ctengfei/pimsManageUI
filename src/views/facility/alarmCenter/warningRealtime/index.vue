<template>
  <div class="app-container-gis">
    <div id="cesiumContainer">
          ...
          <div style="margin:0 5px;width:100%">
            <el-row :gutter="10">
              ...
              >
                ...
                <el-col :span="24">
                  <el-form-item prop="carType" label="告警时间">
                    <el-date-picker
                      v-model="time"
                      type="daterange"
                ...
                <el-form-item prop="eventCode" label="告警事件">
                  <el-select v-model="formSeach.eventCode" style="width: 286px" placeholder="请选择事件名称" clearable>
                    <el-option
                ...
                <el-col :span="24">
                  <el-form-item prop="level" label="告警级别">
                    <el-select v-model="formSeach.level" style="width: 286px" clearable placeholder="请选择告警级别">
                        <el-option
                ...
                <!-- <el-col :span="24">
                  <el-form-item prop="businessCode" label="告警事件">
                    <el-select v-model="formSeach.businessCode" style="width: 286px" clearable placeholder="请选择业务类型">
                      <el-option
                ...
                <!-- <el-col :span="24">
                  <el-form-item prop="status" label="告警状态">
                    <el-select v-model="formSeach.status" style="width: 286px" clearable placeholder="请选择告警状态">
                        <el-option
      ...
      <div class="centerBox">
        <el-row :gutter="20">
          <el-col :span="6" v-for="(item,index) in eventStatistics" :key="index">
      ...
      <div class="rightBox padding-10" v-if="roundPatrolShow">
        <!-- <div style="line-height:36px;color: #fff;">告警详情</div> -->
        ...
        <div style="margin-top: 5px;">
          <el-form :model="roundPatrol" ref="roundPatalForm" label-width="80px" label-position="left">
            ...
            <el-form-item label="设备名称">
              <span>GJ2023010916112004851</span>
            </el-form-item>
        ...
        <div style="line-height:36px;color: #fff;font-size: 14px;">录像视频
          <el-row>
            <el-col :span="24"><div class="grid-content bg-purple-dark"></div>
              <div class='imgBox'>
                  <video :src="video" autoplay="autoplay" width="60" height="40" alt=""/>
                </div>
            </el-col>
          </el-row>
        </div>
        <div style="line-height:36px;color: #fff;font-size: 14px;">关联图片
          <el-row type="flex" class="row-bg" justify="left">
            <el-col :span="6">
              <div class="grid-content bg-purple">
                <div class='imgBox'>
                  <img :src="picture" width="60" height="40" alt="">
                </div>
            </div>
            </el-col>
...
<script>
  ...
  import {getTableData, getAlarmId, alarmAssign, alarmClose, manualAralm,getConfigCodeEvent,getstatisticsEvent} from '@/api/alarmCenter/warningRealtime'
