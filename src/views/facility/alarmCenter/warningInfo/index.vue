    ...
    <div v-if="workPageShow" style="height: 100%">
      ...
      <!-- <div class="workInfo"> -->
        ...
        <el-table :data="tableData" style="width: 100%;" @selection-change="multipleChange">
          ...
          <el-table-column prop="eventName" label="事件名称" showOverflowTooltip></el-table-column>
          ...
          <el-table-column prop="alarmLevel" label="告警级别" showOverflowTooltip>
            <template slot-scope="scope">
              <span v-if="scope.row.alarmLevel == 'normal'">普通</span>
              <span v-else-if="scope.row.alarmLevel == 'emergency'">紧急</span>
              <span v-else-if="scope.row.alarmLevel == 'veryEmergency'">非常紧急</span>
            </template>
          </el-table-column>
          <el-table-column prop="status" label="处理状态" showOverflowTooltip>
            <template slot-scope="scope">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <el-button @click="onDetail(scope.row)" type="text" icon="el-icon-detail">详情</el-button>
...
<script>
  ...
  import {getTableData, getAllWarning, download, getConfigEvent} from '@/api/alarmCenter/warningInfo'
