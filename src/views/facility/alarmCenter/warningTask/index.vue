<template>
  <div class="app-container">
    <div v-if="workPageShow">
      ...
      <!-- <div class="workInfo"> -->
        ...
        <el-table :data="tableData" style="width: 100%">
          ...
          <el-table-column prop="processorName" label="执行人" showOverflowTooltip></el-table-column>
    ...
    <div v-if="workDetailShow" style="height: 100%">
      <el-dialog
        title="详情"
          ...
          if(res.code === 200){
            ...
            for(let key in obj){
              if(key === "totalAmount"){
                ...
                temp.push({label:"待分派", num:obj[key]})
      ...
      onSubmit() {
        if (this.toData.length == 0) {
          // if (this.toData[0].children.length == 1) {
            ...
            if (this.title == "指派") {
              alarmOrderAssign(data).then(res=>{
                if(res.code === 200) {
