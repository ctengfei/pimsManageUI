...
export default {
  ...
  data() {
    return {
      // permission: {
      //   search: "facility::maintenanceRecord::search",
      //   download: "facility::maintenanceRecord::download",
  ...
  methods: {
    ...
    getTableData() {
      ...
      initTabData('/deviceInspection/deviceInspection/page', 'get', data).then((res) => {
        if (res.code === 200) {
    ...
    btnExport() {
      ...
      let data = this.formSearch;
      downloadworkOrder('/deviceInspection/deviceInspection/page/export', 'get', data)
        .then((res) => {
