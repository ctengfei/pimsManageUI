<template>
  <div style="height: 100%">
        ...
        <el-row>
          <el-row>
            <div class="flexboxs">
              ...
              <div class="flexboxs">
                <span class="video-web-content-title" style="font-size:16px;text-align: center;font-weight: 700;">{{parentData.code}}</span>
              ...
              <el-form label-width="80px" class="basicInfos infos">
                ...
                <el-col>
                  <el-form-item label="事件名称">
                    <el-input v-model="create.eventName" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                  <el-form-item label="业务分类">
                    <el-input v-model="create.businessName" disabled></el-input>
                  </el-form-item>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12" v-if="create.captureRecords && create.alarmRecords.length">
            ...
            <el-form label-width="80px" class="basicInfos">
              ...
              <el-col>
                <el-form-item label="任务名称">
                  <el-input v-model="accept.title" disabled/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="期望完成时间" label-width="100px">
                  <el-input v-model="accept.expectTime" disabled/>
                </el-form-item>
              </el-col>
              <el-col :span="12">
                <el-form-item label="任务优先级" label-width="100px">
                  <el-input :value="accept.priority == 'NORMAL' ? '普通告警' : accept.priority == 'EMERGENCY' ? '严重告警' : '紧急告警' " disabled/>
                </el-form-item>
              </el-col>
              <el-col :span="24">
                <el-form-item label="位置信息">
                  <el-input type="textarea" :rows="2" v-model="accept.location" disabled></el-input>
                </el-form-item>
              </el-col>
              <!-- <el-col>
      ...
      <div class="rightInfo" >
        <div class="margin-bottom-20 infos">
          <span class="workInfo" style="font-weight:700;color: #606266;font-size: 16px;">
             <!-- <img src="@/assets/images/arrow.png" style="background: rgb(96, 98, 102);" alt=""> -->
            任务操作记录
          </span>
        </div>

        <div class="stepss" v-if="recordData.length">
            ...
            <div class="s_l">
              <div class="info_item">
                <div class="titleStatus">
                  ...
                  <div v-if="i.workOrderStatus=='待分派'" class="title handleStatus">{{i.workOrderStatus}}</div>
                ...
                <div class="contents" v-if="i.mediaMeta">
                  ...
                  <span v-if="i.mediaMeta.pictures.length > 0">
                    <i class="el-icon-picture" :class="item.fullPath ? 'bgc' : ''" v-for="(item,index) in i.mediaMeta.pictures"
                      @click="bigImage(item)"
        ...
        <div v-else >
          <div class="el-table__empty-block" style="height: 100%;"><span class="el-table__empty-text" style="width:100%">暂无数据</span></div>
        </div>
      </div>
    </div>
    <el-dialog
    ...
    <!-- <div v-show="crameShow" class="crameShowMask">
          ...
          <div class="vedioShow">
            <div style="width: 45vw; height: 30vh">
                <VideoPlayerGroup 
                    ref="videoPlayerGroup"
                />
              </div>
  ...
  export default {
    ...
    methods: {
      ...
      getWorkOrderById() {
        ...
        messApi.getAlarmIdDetail(id).then(res => {
          if (res.code === 200) {
            this.detail = res.data;
            this.create = res.data;
            this.recordData = res.data.workOrderRecords;
            this.parentData.status = res.data.status
            this.parentData.code = res.data.code
            // this.accept = res.data.alarmWorkOrderMessage;
