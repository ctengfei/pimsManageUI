<template>
  <div>
      ...
      <div class="flexboxs">
        ...
        <el-row>
          <el-form label-width="80px" class="basicInfos">
            <el-col>
              <div class="el-descriptions__title mb20">任务信息</div>
            </el-col>
            <el-col>
        ...
        <div  style="width:100%">
          <el-row>
            <el-form label-width="80px" class="basicInfos infos">
              <el-col>
                <div class="el-descriptions__title mb20">告警信息</div>
              </el-col>
              <el-col>
              ...
              <el-col :span="12">
                <el-form-item label="告警级别">
                  <el-input :value="parentData.priority == 'normal' ? '普通' : parentData.priority == 'emergency' ? '紧急' : '非常紧急' " disabled></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="12">
              ...
              <el-col>
                <el-form-item label="位置信息">
                  <el-input type="textarea" v-model="accept.location" disabled></el-input>
                </el-form-item>
              </el-col>
            </el-form>
          </el-row>
    ...
    <div class="rightInfo">
      <div class="el-descriptions__title mb20">工单操作记录</div>
