  ...
  <div class="app-container">
    ...
    <div class="video-web-right-box-bottom">
      ...
      <el-form
        ...
        class="mt20"
      >
        <el-form-item prop="name" label="锅炉房名称">
          <el-input
            v-model="form.name"
      ...
      <div class="photoBox" v-if="tableData && tableData.length">
        <div class="groups" v-for="(item,index) in tableData" :key="index">
          ...
          <div class="infomation">
            ...
            <div v-for="(items,indexs) in item.pointRunDataList" :key="indexs">
              <div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        spanList: [
          {
            type: "icon_glfzongshu",
            num: 0,
            name: "锅炉房总数",
            path: require(`@/assets/icons/svgui/icon_glfzongshu.svg`),
          },
          {
            type: "icon_icon_glfon",
            num: 0,
            name: "锅炉房开启",
            path: require(`@/assets/icons/svgui/icon_icon_glfon.svg`),
          },
          {
            type: "icon_glfclose",
            num: 0,
            name: "锅炉房关闭",
            path: require(`@/assets/icons/svgui/icon_glfclose.svg`),
      },
          {
            type: "icon_glfguzhang",
            num: 0,
            name: "锅炉房故障",
            path: require(`@/assets/icons/svgui/icon_glfguzhang.svg`),
          },
          {
            type: "icon_glfbaojing",
            num: 0,
            name: "锅炉房报警",
            path: require(`@/assets/icons/svgui/icon_glfbaojing.svg`),
          },
        ],
        crameShow:false,
        rtspUrl:'',
