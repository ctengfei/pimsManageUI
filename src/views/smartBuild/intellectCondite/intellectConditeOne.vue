      ...
      <el-col :xl="20" :lg="18" :sm="17" :xs="24">
        ...
        >
          ...
          <el-form-item style="float: right;margin-right:0px;">
            <el-button @click="batchStart()" type="primary" plain round
            >一键启动
            </el-button>
            <el-button @click="batchClose()" type="danger" plain round
            >一键关闭
            </el-button>
        ...
        <div>
          <div class="photoBox" v-if="tableData && tableData.length">
              <div class="groups" v-for="(item, index) in tableData" :key="index">
                <div class="imgTitle">
                ...
                <div class="infomation">
                  ...
                  <div class="margin0" style="margin-top:10px">
                    <span
                      v-for="(items, index) in item.pointRunDataList"
                      :key="index"
                    >
            ...
            <div v-else style="text-align:center">
              <div class="el-table__empty-text" style="margin:0 auto;font-size:20px;">
                暂无数据
              </div>
            </div>
            <!--分页 -->
        ...
        spanList: [
          {
            ...
            num: 0,
            name: "设备总数",
            path: require(`@/assets/icons/svgui/icon_ktshebeizongshu.svg`)
          },
          {
            type: "icon_ktshebeion",
            num: 0,
            name: "设备开机",
            path: require(`@/assets/icons/svgui/icon_ktshebeion.svg`)
          },
          {
            type: "icon_ktshebeiclose",
            num: 0,
            name: "设备关机",
            path: require(`@/assets/icons/svgui/icon_ktshebeiclose.svg`)
          },
          {
            type: "icon_ktshebeiyichang",
            num: 0,
            name: "设备异常",
            path: require(`@/assets/icons/svgui/icon_ktshebeiyichang.svg`)
          },
          // {
          //   type: "exception",
          //   num: 0,
