    ...
    <el-row :gutter="20">
      <el-col :xl="4" :lg="6" :sm="7" :xs="24">
        <OrgizeTree
          ...
          :draggable="draggable"
          :nodeType="nodeType"
          :accessPartyCode="accessPartyCode"
      ...
      <el-col :xl="20" :lg="18" :sm="17" :xs="24">
        ...
        <el-form
          ...
          ref="serForm"
          :model="form">
          <el-form-item prop="name" label="空调机组名称">
            <el-input
              v-model="form.name"
        ...
        <div class="photoBox" v-if="tableData && tableData.length">
          ...
          >
            ...
            <div class="infomation">
              ...
              >
                <div>
                  <span v-show="items.pointType == 'RoomTempSp'">
                    <span class="pointName">{{ items.pointName }}</span>
                    <span class="bgCond bgSucc">{{items.dataValue}}{{ "℃" }}</span>
                  </span>
                  <span v-show="items.pointType == 'ModeStatus'">
                    <span class="pointName">{{ items.pointName }}</span>
                    <span class="bgCond bgSucc">{{
                    items.dataValue == 1 ? '制冷' : items.dataValue == 2 ? '制热' : items.dataValue == 3 ? '除湿' : items.dataValue == 4 ? '送风' : '自动'
                    }}</span>
                  </span>
                  <span v-show="items.pointType == 'RoomTemperature'">
                    <span class="pointName">{{ items.pointName }}</span>
                    <span class="bgCond bgSucc">{{items.dataValue}}{{ "℃" }}</span>
                  </span>
                  <span v-show="items.pointType == 'WindSpeed'">
                    <span class="pointName">{{ items.pointName }}</span>
                    <span class="bgCond bgSucc">{{
                    items.dataValue == 1 ? '低风挡' : items.dataValue == 2 ? '中风档' : items.dataValue == 3 ? '高风档' : '自动挡'
                    }}</span>
                  </span>
                  <span
                    v-show="
  ...
  export default {
    ...
    data() {
      return {
        ...
        spanList: [
          {
            type: "icon_ktshebeizongshu",
            num: 0,
            name: "设备总数",
            path: require(`@/assets/images/smartBuild/ktone.png`)
          },
          {
            type: "icon_ktshebeion",
            num: 0,
            name: "设备开机",
            path: require(`@/assets/images/smartBuild/kttwo.png`)
          },
          {
            type: "icon_ktshebeiclose",
            num: 0,
            name: "设备关机",
            path: require(`@/assets/images/smartBuild/ktthree.png`)
          },
          {
            type: "icon_ktshebeiyichang",
            num: 0,
            name: "设备异常",
            path: require(`@/assets/images/smartBuild/ktfour.png`)
          },
        ],
        crameShow:false,
        rtspUrl:'',
