                      ...
                      <el-table-column prop="switchStatus" label="设备操作" showOverflowTooltip>
                          <template slot-scope="scope">
                              <div class="lightSet">
                                  ...
                                  <el-button @click="toDeviceDraw(scope.row)" type="primary" style="margin-left:20px;">设备画像</el-button>
                              </div>
                          </template>
                      </el-table-column>
...
export default {
  ...
  data() {
      return {
          ...
          spanList: [
              {
                  type: "icon_yjshebeizongshu",
                  num: null,
                  name: "设备总数",
                  path: require(`@/assets/icons/svgui/icon_yjshebeizongshu.svg`),
              },
              {
                  type: "icon_yjshebeion",
                  num: null,
                  name: "设备开启",
                  path: require(`@/assets/icons/svgui/icon_yjshebeion.svg`),
              },
              {
                  type: "icon_yjshebeiclose",
                  num: null,
                  name: "设备关闭",
                  path: require(`@/assets/icons/svgui/icon_yjshebeiclose.svg`),
              },
              {
                  type: "icon_yjshebeilixian",
                  num: null,
                  name: "设备离线",
                  path: require(`@/assets/icons/svgui/icon_yjshebeilixian.svg`),
              }
          ],
          multipleSelection: []
      };
  ...
  methods: {
    ...
    this.getNightlighTable();
      ...
      getNightlighTable(){
          ...
          $smartBuild.getCriteria(this.form).then(res=>{
              if(res.code === 200){
...
//            this.getDeviceData(data)
      ...
      getLoopControl(data){
          ...
          $smartBuild.getLoopControl(data).then(res=>{
