...
// 查询智慧综治-基础业务-护路护线_线路管理列表
export function listXlgl(query) {
    return request({
      url: '/jcyw/hlhx/xlgl/list',
      method: 'get',
      params: query
    })
  }
  
  // 查询智慧综治-基础业务-护路护线_线路管理详细
  export function getXlgl(id) {
    return request({
      url: '/jcyw/hlhx/xlgl/' + id,
      method: 'get'
    })
  }
  
  // 新增智慧综治-基础业务-护路护线_线路管理
  export function addXlgl(data) {
    return request({
      url: '/jcyw/hlhx/xlgl',
      method: 'post',
      data: data
  ...
  // 修改智慧综治-基础业务-护路护线_线路管理
  export function updateXlgl(data) {
    return request({
      url: '/jcyw/hlhx/xlgl',
      method: 'put',
      data: data
  ...
  // 删除智慧综治-基础业务-护路护线_线路管理
  export function delXlgl(id) {
    return request({
      url: '/jcyw/hlhx/xlgl/' + id,
      method: 'delete'
    })
