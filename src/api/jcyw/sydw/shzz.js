...
// 社会组织统计
export function querySh() {
    return request({
        url: '/jcyw/zzgl/shzz/statistics',
        method: 'get',
    })
}
// 下属机构社会组织统计
export function querysubSh() {
    return request({
        url: '/jcyw/zzgl/shzz/subStatistics',
        method: 'get',
    })
}
