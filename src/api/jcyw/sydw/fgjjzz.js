...
// 非公经济组织统计
export function queryFg() {
    return request({
        url: '/jcyw/zzgl/fgzz/statistics',
        method: 'get',
    })
}
...
// 查询智慧综治-基础业务-实有单位-场所管理列表
export function listFgzz(query) {
    return request({
      url: '/jcyw/zzgl/fgzz/list',
      method: 'get',
      params: query
    })
  }
  
  // 查询智慧综治-基础业务-实有单位-场所管理详细
  export function getFgzz(id) {
    return request({
      url: '/jcyw/zzgl/fgzz/' + id,
      method: 'get'
    })
  }
  
  // 新增智慧综治-基础业务-实有单位-场所管理
  export function addFgzz(data) {
    return request({
      url: '/jcyw/zzgl/fgzz',
      method: 'post',
      data: data
  ...
  // 修改智慧综治-基础业务-实有单位-场所管理
  export function updateFgzz(data) {
    return request({
      url: '/jcyw/zzgl/fgzz',
      method: 'put',
      data: data
  ...
  // 删除智慧综治-基础业务-实有单位-场所管理
  export function delFgzz(id) {
    return request({
      url: '/jcyw/zzgl/fgzz/' + id,
      method: 'delete'
    })
