...
export function listCsgl(query) {
    return request({
      url: '/jcyw/sydw/csgl/list',
      method: 'get',
      params: query
  ...
  export function getCsgl(id) {
    return request({
      url: '/jcyw/sydw/csgl/' + id,
      method: 'get'
    })
  }
  
  // 新增智慧综治-基础业务-实有单位-场所管理
  export function addCsgl(data) {
    return request({
      url: '/jcyw/sydw/csgl',
      method: 'post',
      data: data
  ...
  export function updateCsgl(data) {
    return request({
      url: '/jcyw/sydw/csgl',
      method: 'put',
      data: data
