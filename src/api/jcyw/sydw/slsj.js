...
// 查询护路护线-涉路事件列表
export function listSlsj(query) {
    return request({
      url: '/jcyw/hlhx/slsj/list',
      method: 'get',
      params: query
    })
  }
  ...
  // 查询护路护线-涉路事件详细
  export function getSlsj(id) {
    return request({
      url: '/jcyw/hlhx/slsj/' + id,
      method: 'get'
    })
  }
  
  // 新增护路护线-涉路事件
  export function addSlsj(data) {
    return request({
      url: '/jcyw/hlhx/slsj',
      method: 'post',
      data: data
  ...
  // 修改护路护线-涉路事件
  export function updateSlsj(data) {
    return request({
      url: '/jcyw/hlhx/slsj',
      method: 'put',
      data: data
  ...
  // 导出护路护线-涉路事件
  export function exportSlsj(query) {
    return request({
      url: '/jcyw/hlhx/slsj/export',
      method: 'post',
      params: query
    })
  }
