...
export function updateGark (data) {
  return request({
    url: '/jcyw/syrk/zdqsn/updateById',
    method: 'put',
    data: data
  })
}
...
export function delGark (id, bqId) {
  return request({
    url: `/jcyw/syrk/zdqsn/removeById/${id}/${bqId}`,
    method: 'delete'
  })
}
...
export function multipleDelGark (data) {
  return request({
    url: '/jcyw/syrk/zdqsn/removeByIds',
    method: 'post',
    data: data
  })
}
...
export function getCountByType (params) {
  return new Promise(resolve => {
    request({
      url: '/jcyw/syrk/zdqsn/getZdqsnLxCount',
      method: 'get',
      params
    }).then(res => {
      resolve(res);
...
export function getStatistics () {
  return request({
    url: '/jcyw/syrk/zdqsn/statistics',
    method: 'get',
  })
}