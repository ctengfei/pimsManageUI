...
export function delGark (id, bqId) {
  return request({
    url: `/jcyw/bqgl/removeBqryById/${id}/${bqId}`,
    method: 'delete'
  })
}
...
// 获取二级标签列表
export function getBqList () {
  return request({
    url: '/jcyw/bqgl/getRyBqCodeList',
    method: 'get',
  })
}
