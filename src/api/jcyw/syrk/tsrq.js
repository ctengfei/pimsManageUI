...
export function listHjrk (data) {
  return request({
    url: `/jcyw/syrk/tsrq/getTsrqListByType`,
    method: 'get',
    params: data
  })
}
...
export function getGaryInfo (sfz, bqId) {
  return request({
    url: `/jcyw/syrk/tsrq/queryTsrqBySfzhm/${sfz}/${bqId}`,
    method: 'get'
  })
}
// 新增智慧综治_基础业务_人口_关爱人口
export function addGark (data, type) {
  return request({
    url: `/jcyw/syrk/tsrq/add?type=${type}`,
    method: 'post',
    data: data
  })
}
...
// 修改智慧综治_基础业务_人口_关爱人口
export function updateGark (data, type) {
  return request({
    url: `/jcyw/syrk/tsrq/updateById?type=${type}`,
    method: 'put',
    data: data
  })
}
...
export function delGark (id, bqId) {
  return request({
    url: `/jcyw/syrk/tsrq/removeById/${id}/${bqId}`,
    method: 'delete'
  })
}
// 批量删除智慧综治_基础业务_人口_关爱人口
export function multipleDelGark (ids, bqIds) {
  return request({
    url: `/jcyw/syrk/tsrq/removeByIds/${ids}/${bqIds}`,
    method: 'delete'
  })
}
...
export function getCountByType (params) {
  return new Promise(resolve => {
    request({
      url: '/jcyw/syrk/tsrq/getTsrqLxCount',
      method: 'get',
      params
    }).then(res => {
      resolve(res);
